// Client-side copy of src/data/realPortfolioData.js, for building form pickers (e.g. UC1's
// "Allocate Funds" security list) without a network round-trip. The Node build's model
// computations (UC3/UC4/UC5) use the server-side copy; this file only feeds UI labels/prices.
// Keep in sync with src/data/realPortfolioData.js (and the equivalent block in module4-static/js/models.js).
(function (global) {
  ...
  global.WISRealHoldings = RAW_HOLDINGS.map(buildHolding);
})(window);
